/****************************************************************************
** Meta object code from reading C++ file 'DropLabel.hpp'
**
...
#include "../../../src/widgets/DropLabel.hpp"
...
#error "The header file 'DropLabel.hpp' doesn't include <QObject>."
...
void DropLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DropLabel::*)(const QString & )>(_a, &DropLabel::imageDropped, 0))
            return;
    }
}
...
// SIGNAL 0
void DropLabel::imageDropped(const QString & _t1)
{
